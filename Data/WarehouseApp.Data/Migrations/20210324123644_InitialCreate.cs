    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CupboardProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CupboardProducts_Cupboards_CupboardId",
                        column: x => x.CupboardId,
                        principalTable: "Cupboards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CupboardProducts_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CupboardProducts_CupboardId",
                table: "CupboardProducts",
                column: "CupboardId");

            migrationBuilder.CreateIndex(
                name: "IX_CupboardProducts_ProductId",
                table: "CupboardProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Cupboards_IsDeleted",
                table: "Cupboards",
                column: "IsDeleted");
